...
function UGThumbsGeneral(){
	...
	var g_options = {
		...
		imageAlt = g_functions.htmlentitles(imageAlt);
				...
				//debugger
					var htmlThumb = "<a href='" + urlLink + "'"+linkTarget+" data-toggle='modal' data-target='#"+imageAlt+"' class='ug-thumb-wrapper"+classAddition+"'></a>";
...
function UGTileDesign(){
	...
	function setHtmlThumb(objThumbWrapper, objItem){
		...
		if(g_options.tile_enable_background == true){
			objCss["background-color"] = "";//фон подложки
		}
